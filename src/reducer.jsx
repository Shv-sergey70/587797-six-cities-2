...
import {getRandomElementFromArray, getUniqueCities, isEmptyObject} from "./utils";
...
export const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case ActionType.LOAD_OFFERS:
      ...
      return Object.assign({}, state, {
        offers,
        currentCity: !isEmptyObject(currentCity) ? currentCity : getRandomElementFromArray(getUniqueCities(offers)),
